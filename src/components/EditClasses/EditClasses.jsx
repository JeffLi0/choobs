				...
				if (selectedClasses.includes(id)) {
					...
					if (correspondingElement) {
						if (
							...
							correspondingElement.classList.remove(
								styles.disabled,
							);
						} else if (
							...
							<div>
								...
								<div className={styles.buttons}>
												...
												if (
													(!(
														selectedClasses.every(
															(val) =>
																previouslySelected.includes(
																	val,
																),
														) &&
														previouslySelected.every(
															(val) =>
									...
									>
										{buttonLoading ? (
											<div
												className={`lds-ring ${styles.loadingRing}`}
											>
												<div></div>
												<div></div>
												<div></div>
						...
						>
							...
							<span>
								<p>
									...
									<b>"{subject}"</b> from your classes? This
									will remove the following block
