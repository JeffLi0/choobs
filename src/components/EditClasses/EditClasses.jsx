          ...
          classesToDelete.push(
            ...selectedClasses
              ...
              .flatMap((id) => {
                ...
                if (
                  ["C$1", "G$1", "G$2", "C$3", "G$3", "G$4"].indexOf(id) > -1
                ) {
                  return [
        ...
        const isDisabled = () => {
          if (["I"].includes(id)) {
            ...
            return correspondingElements.some((element) =>
              scheduleData.some((block) => block.block === element),
            );
          }
          return false;
        };
      ...
      lunchBlocks.forEach((id) => {
        ...
        if (selectedClasses.includes(id)) {
          if (correspondingElement) {
            ...
            if (["C$1", "G$1", "G$2", "C$3", "G$3", "G$4"].indexOf(id) > -1) {
              let index = ["C$1", "G$1", "G$2", "C$3", "G$3", "G$4"].indexOf(
                id,
              );
              ...
              document
                .getElementById(["D1", "H1", "H2", "D3", "H3", "H4"][index])
      ...
      setPreviouslySelected(
        [].concat(
          ...scheduleData
            .filter(
              (item) =>
                item.classNames[0] === matchingData.classNames[0] &&
                item.classNames[1] === matchingData.classNames[1],
            )
            .map((item) => item.block),
        ),
      );
  ...
  return (
    <>
      <div className={styles.editClasses}>
          ...
          <button
            onClick={async () => {
              ...
              try {
                ...
                if (!schedule.some((s) => s)) throw new Error("Invalid PDF.");
                  ...
                  <button
                    ...
                    disabled={(() => {
                      if (deleteMode) {
                        if (
                          (!(
                            selectedClasses.every((val) =>
                              previouslySelected.includes(val),
                            ) &&
                            previouslySelected.every((val) =>
                              selectedClasses.includes(val),
                            )
                          ) &&
        ...
        {showDeleteModal && (
          <div
            className={`${styles.modalContainer} ${deleteModalFade ? styles.fade : ""}`}
          ...
          >
            ...
            >
              ...
              <span>
                <p>
                  Are you sure you want to delete <b>"{subject}"</b> from your
                  classes? This will remove the following block
