      ...
      for (const [date, dayEvents] of Object.entries(eventsByDate)) {
        ...
        if (!isHalfDay) {
          if (dayEvents.some((event) => /^(C|G)\$[1-4]$/.test(event.summary))) {
            ...
            dayEvents.some((event) => /^(D|H)\$[1-4]$/.test(event.summary))
          ) {
            dayEvents.forEach((event) => {
              ...
              if (lastBlockEvent) {
                if (
                  ...
                  lastBlockEvent.end.dateTime = new Date(
                    new Date(lastBlockEvent.end.dateTime).setHours(
                      11,
                      25,
                      0,
                      0,
  ...
  return (
    <>
      <div className={styles.category}>
        ...
        <span>
          View your schedule on Google Calendar or your preferred calendar app.
        </span>
        ...
        >
          ...
          >
            ...
            <ol>
              ...
              <li>
                Select “Add calendar” and “Create new calendar” in the left
                sidebar,
              </li>
