...
function Settings(props) {
        ...
        if (
          ...
          if (userData) {
            ...
            setEmailNotifications(
              userDataSnapshot.data().preferences.emailNotifications,
            );
  ...
  return (
    <>
      <div className={`${styles.header} ${!isMobile ? styles.desktop : ""}`}>
                    ...
                    >
                      ...
                      >
                        ...
                        <Picker
                          ...
                          dynamicWidth={true}
                          onEmojiSelect={updatePreviewPFP}
                        />
                        <div className={styles.modalButtons}>
                          ...
                          <button
                            ...
                            disabled={userData.pfp === previewPFP}
                          >
                            Save
                          </button>
                        </div>
