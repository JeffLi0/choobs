			...
			<div className={isMobile ? styles.header : styles.desktopHeader}>
				...
				<div className={styles.calendar}>
					...
					<div className={styles.week}>
						...
						>
							<p>
								{getShortDayOfWeek(displayDate.getDate() - 2)}
							</p>
						...
						>
							<p>
								{getShortDayOfWeek(displayDate.getDate() - 1)}
							</p>
						...
						events
							.filter((event) => {
								if (
									...
									const hasHalfDay = fullDayEvent.some(
										(element) =>
									...
									if (
										matchingData &&
										!blocksRendered.includes(
											event.summary,
										) &&
										new Date(
											event.start.dateTime,
										).getDate() === displayDate.getDate()
									) {
