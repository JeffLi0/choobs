      ...
      <div className={styles.page}>
        <div className={styles.logoWrapper}>
          <img
            ...
            src={document.location.origin + "/static/maskable_icon_x512.png"}
            alt="logo"
          />
          <h4>choobs.app</h4>
        </div>
        ...
        {isMobile ? (
          <img
            ...
            src={document.location.origin + "/static/screenshot_mobile.png"}
            alt="screenshot"
          />
        ) : (
          <img
            className={`${styles.screenshot} ${styles.desktop}`}
            src={document.location.origin + "/static/screenshot_desktop.png"}
            alt="screenshot"
          />
        )}
      </div>
